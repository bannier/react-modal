...
exports.htmlOpenClassName = exports.bodyOpenClassName = exports.portalClassName = undefined;
...
var htmlOpenClassName = exports.htmlOpenClassName = "ReactModal__Html--open";
...
var ModalPortal = function (_Component) {
  ...
  function ModalPortal(props) {
    ...
    _this.afterClose = function () {
      ...
      classList.remove(document.body, _this.props.bodyOpenClassName);
      classList.remove(document.getElementsByTagName("html")[0], _this.props.htmlOpenClassName);
...
function add(element, elementClass) {
  // Increment class(es) on refCount tracker and add class(es) to body
  elementClass.split(" ").map(refCount.add).forEach(function (className) {
    return element.classList.add(className);
  });
}

function remove(element, elementClass) {
  var classListMap = refCount.get();
  // Decrement class(es) from the refCount tracker
  // and remove unused class(es) from body
  elementClass.split(" ").map(refCount.remove).filter(function (className) {
